...
VALUES
(N'MCH-001', N'Máy sấy xoài 01', N'BLD-001', N'USR-EMP-001', N'SCH-MANGO-STD', N'FT-MANGO', 1, 0, 59.00, 58.00, 62.00, 35.00, 30.00, 40.00, 4, 4, 1, N'automatic', N'A-01', N'Heat Pump'),
...
(N'MCH-003', N'Máy sấy thanh long 01', N'BLD-002', N'USR-EMP-003', N'SCH-DRAGON-STD', N'FT-DRAGON', 1, 0, 56.00, 55.00, 60.00, 40.00, 35.00, 45.00, 4, 3, 1, N'automatic', N'B-01', N'Heat Pump'),
(N'MCH-004', N'Máy sấy dứa 01', N'BLD-002', N'USR-EMP-001', N'SCH-PINEAPPLE-STD', N'FT-PINEAPPLE', 1, 0, 60.00, 57.00, 63.00, 33.00, 28.00, 38.00, 4, 4, 1, N'manual', N'B-02', N'Hybrid'),
