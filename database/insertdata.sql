...
INSERT INTO Schedules (scheduleId, scheduleName, fruitTypeId, description, durationMinutes, targetTempMin, targetTempMax, targetHumidityMin, targetHumidityMax)
VALUES
(N'SCH-MANGO-STD', N'Xoài tiêu chuẩn', N'FT-MANGO', N'Sấy xoài lát ở nhiệt độ trung bình, giữ độ dẻo', 720, 50.00, 60.00, 30.00, 45.00),
(N'SCH-BANANA-LOW', N'Chuối nhiệt thấp', N'FT-BANANA', N'Sấy chuối ở nhiệt thấp để giữ màu', 600, 45.00, 55.00, 35.00, 50.00),
(N'SCH-DRAGON-STD', N'Thanh long tiêu chuẩn', N'FT-DRAGON', N'Sấy thanh long cắt lát mỏng', 480, 52.00, 62.00, 30.00, 40.00),
(N'SCH-PINEAPPLE-STD', N'Dứa tiêu chuẩn', N'FT-PINEAPPLE', N'Sấy dứa lát, độ ẩm đầu ra thấp', 540, 55.00, 65.00, 25.00, 35.00),
(N'SCH-LONGAN-STD', N'Nhãn tiêu chuẩn', N'FT-LONGAN', N'Sấy nhãn giữ mùi thơm tự nhiên', 660, 50.00, 65.00, 20.00, 35.00);
GO
...
(N'STEP-MANGO-002', N'SCH-MANGO-STD', 2, 360, 58.00, 62.00, 30.00, 40.00, 3, 4, 0),
...
(N'STEP-DRAGON-002', N'SCH-DRAGON-STD', 2, 240, 55.00, 60.00, 35.00, 45.00, 3, 4, 0),
...
(N'STEP-PINE-002', N'SCH-PINEAPPLE-STD', 2, 300, 57.00, 63.00, 28.00, 38.00, 3, 4, 0),
...
(N'STEP-LONGAN-002', N'SCH-LONGAN-STD', 2, 360, 60.00, 65.00, 25.00, 35.00, 3, 4, 0),
...
VALUES
(N'MCH-001', N'Máy sấy xoài 01', N'BLD-001', N'USR-EMP-001', N'SCH-MANGO-STD', N'FT-MANGO', 1, 0, 59.00, 58.00, 62.00, 35.00, 30.00, 40.00, 3, 4, 1, N'automatic', N'A-01', N'Heat Pump'),
...
(N'MCH-003', N'Máy sấy thanh long 01', N'BLD-002', N'USR-EMP-003', N'SCH-DRAGON-STD', N'FT-DRAGON', 1, 0, 56.00, 55.00, 60.00, 40.00, 35.00, 45.00, 3, 3, 1, N'automatic', N'B-01', N'Heat Pump'),
