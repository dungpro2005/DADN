...
declare function getAnimationMap(element: Element): Map<string, NativeAnimation<AnyResolvedKeyframe>>;
...
declare function getFinalKeyframe<T>(keyframes: T[], { repeat, repeatType }: AnimationPlaybackOptions, finalKeyframe?: T, speed?: number): T;
 ...
 */
declare function isTransitionDefined(transition: Transition & {
    elapsed?: number;
...
declare function createTransformer(source: AnyResolvedKeyframe): (v: (string | number | Color)[]) => string;
 ...
 */
declare function transformBox(box: Box, transform: ResolvedValues$1, sourceBox?: Box): void;
...
declare function calcRelativeAxis(target: Axis, relative: Axis, parent: Axis, anchor?: number): void;
declare function calcRelativeBox(target: Box, relative: Box, parent: Box, anchor?: Point): void;
declare function calcRelativeAxisPosition(target: Axis, layout: Axis, parent: Axis, anchor?: number): void;
declare function calcRelativePosition(target: Box, layout: Box, parent: Box, anchor?: Point): void;
...
declare const DocumentProjectionNode: {
    new (latestValues?: ResolvedValues$1, parent?: IProjectionNode<unknown> | undefined): {
        ...
        applyTransform(box: motion_utils.Box, transformOnly?: boolean, output?: motion_utils.Box | undefined): motion_utils.Box;
